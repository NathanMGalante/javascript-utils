 ...
 * 
 * @param value - The CPF to be formatted.
 * @returns The formatted CPF or an empty string if the input is invalid.
 */
 ...
 * 
 * @param value - The CNPJ to be formatted.
 * @returns The formatted CNPJ or an empty string if the input is invalid.
 */
 ...
 * 
 * @param document - The raw document value.
 * @returns The formatted document string or an empty string if invalid.
 */
export const formatDocument = (document: string | number): string => {
